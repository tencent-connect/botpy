...
| 对应函数                                                    | 说明             |
| ------------------------------------------------------- | -------------- |
| on_group_message_create(self, message: GroupMessage)    | 当收到群消息时        |
| on_group_at_message_create(self, message: GroupMessage) | 当收到群@机器人的消息时  |
| on_c2c_message_create(self, message: C2CMessage)        | 当收到C2C消息时      |

- **注：需要引入`GroupMessage`、`C2CMessage`**

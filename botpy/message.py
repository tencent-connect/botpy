...
class MessageGroupManage:
    ...
    def __init__(self, api: BotAPI, event_id, data: gateway.MessageGroupManagePayload):
        self._api = api
    ...
    async def reply(self, **kwargs):
        return await self._api.post_group_messages(group_openid=self.group_openid, **kwargs)

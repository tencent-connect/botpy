...
async def _direct_message_handler(context: WsContext, message: botpy.Message):
    """
    定义事件回调的处理
    ...
    """
    msg_api = botpy.AsyncDmsAPI(t_token, False)
    # 打印返回信息
...
if __name__ == "__main__":
    ...
    qqbot_handler = botpy.Handler(botpy.HandlerType.DIRECT_MESSAGE_EVENT_HANDLER, _direct_message_handler)
